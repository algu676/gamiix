...
<body>
  ...
  <nav class="topmenu">
    ...
    <div class="list">
      <div>
        <a href="../CODE/index.html" style="text-decoration:none;" class="nav1">回到首頁</a>
        <a href="../CODE/cate.jsp" style="text-decoration:none;" class="nav2">遊戲選單</a>
        <a href="../CODE/checklogin.jsp" style="text-decoration:none;" class="nav5">會員專區</a>
