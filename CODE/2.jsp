...
<head>
  ...
  <title>GAMIIX</title>
  <link rel="icon" type="image/x-icon" href="../CODE/1234.png">
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11.1.9/dist/sweetalert2.min.css">
  ...
  <script>
    ...
    function redirectToBuyPage() {
      window.location.href = "../CODE/buy.html";
    }
    function showAlert() {
      alert(num);
    }
...
<body>
  ...
  <nav class="topmenu">
    <div class="gotop">
      <a href="#top">
        <img src="../img/up.png" alt="goup" width="50px" />
      </a>
    </div>
    <div class="logo">
      <h1>
    ...
    <div class="list">
      <div>
        ...
        <a href="../CODE/buy.html" style="text-decoration:none;" class="nav6">購物車</a>
      </div>
    </div>
  </nav>
  <!-- header end -->
  ...
  <% if (request.getParameter("ID") != null) {
    ...
    while (rs.next()) {
      ...
      file_path = rs.getString("GameMovie_1");
      ...
      <div class="ad">
        <div class="mySlides fade">
          <video width="540" height="388" controls>
            <source src="../movie/<%=file_path%>.webm" type="video/webm">
            <source src="../movie/<%=file_path%>.mp4" type="video/mp4">
            <source src="../movie/<%=file_path%>.ogg" type="video/ogg">
            no video
          </video>
        </div>
  ...
  <hr color="">
  <!-- 留言表單 -->
  <form id="myForm" action="commet.jsp" method="post">
    <input type="hidden" name="myVariable" id="<%=ID%>">
